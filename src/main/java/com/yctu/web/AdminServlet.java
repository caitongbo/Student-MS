...
public class AdminServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			request.setAttribute("mainPage", "WEB-INF/admin/admin.jsp");
	...
	private void adminSave(HttpServletRequest request,
		...
		try {
			...
			if(StringUtil.isNotEmpty(id)) {
				...
				request.setAttribute("mainPage", "WEB-INF/admin/adminSave.jsp");
				request.getRequestDispatcher("mainAdmin.jsp").forward(request, response);
				try {
					dbUtil.closeCon(con);
				} catch (Exception e) {
	...
	private void adminShow(HttpServletRequest request,
		...
		request.setAttribute("mainPage", "WEB-INF/admin/adminShow.jsp");
		request.getRequestDispatcher("mainAdmin.jsp").forward(request, response);
	}
	...
	private String genPagation(int totalNum, int currentPage, int pageSize){
		...
		if(currentPage==totalPage) {
			...
			pageCode.append("<li><a href='admin?page="+(currentPage+1)+"'>下一页</a></li>");
		}
		pageCode.append("<li><a href='admin?page="+totalPage+"'>尾页</a></li>");
