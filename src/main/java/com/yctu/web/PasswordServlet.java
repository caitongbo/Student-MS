		...
		try {
			...
			if("admin".equals((String)currentUserType)) {
				...
				if(oldPassword.equals(admin.getPassword())) {
					...
					request.setAttribute("mainPage", "WEB-INF/admin/passwordChange.jsp");
				...
				if(oldPassword.equals(student.getPassword())) {
					userDao.adminUpdate(con, student.getId(), newPassword);
					student.setPassword(newPassword);
					request.setAttribute("oldPassword", oldPassword);
					request.setAttribute("newPassword", newPassword);
					request.setAttribute("rPassword", newPassword);
					request.setAttribute("error", "修改成功 ");
					request.setAttribute("mainPage", "WEB-INF/student/passwordChange.jsp");
